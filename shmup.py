...
blue = (0, 0, 225)
yellow = (255, 255, 0)
# initialises and creates the window
pygame.init()
pygame.mixer.init()
screen = pygame.display.set_mode((WIDTH, HEIGHT))
icon = pygame.display.set_icon(pygame.image.load('icon.png'))  # icon
pygame.display.set_caption("Shmup!")  # caption
clock = pygame.time.Clock()

font_name = pygame.font.match_font('arial')

"""
Start of classes and functions
"""
...
def show_go_screen():
    ...
    draw_text(screen, "Arow keys move, space to fire", 22, WIDTH / 2, HEIGHT / 2)
...
player_img = pygame.image.load(path.join(img_dir, "playerImg.png")).convert()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(black)
laser_img = pygame.image.load(path.join(img_dir, "laserImg.png")).convert()
meteor_images = []
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:  # python even type for closing
            running = False  # closes the loop
    # update
    all_sprites.update()
    # check to see if a bullet hit our mob
    ...
    # check to see if a mob hit our player
    ...
    # draw/render
    screen.fill(black)  # fills the background colour
    screen.blit(background, background_rect)
    all_sprites.draw(screen)
    draw_text(screen, str(score), 18, WIDTH / 2, 10)
    # draw_text(screen,"SHIELD: "+str(player.shield),18,WIDTH/4,10)
